    ...
    extends ElectronicFilingMessageType
{
    ...
    protected List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> filingLeadDocument;
    ...
    protected List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> filingConnectedDocument;
     ...
     * 
     */
    public List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> getFilingLeadDocument() {
        if (filingLeadDocument == null) {
            filingLeadDocument = new ArrayList<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>>();
        }
     ...
     * 
     */
    public List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> getFilingConnectedDocument() {
        if (filingConnectedDocument == null) {
            filingConnectedDocument = new ArrayList<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>>();
        }
