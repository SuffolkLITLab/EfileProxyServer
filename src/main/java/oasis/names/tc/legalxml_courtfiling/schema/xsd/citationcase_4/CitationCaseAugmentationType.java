    ...
    extends ComplexObjectType
{
    ...
    protected List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>> vehicle;
     ...
     * 
     */
    public List<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>> getVehicle() {
        if (vehicle == null) {
            vehicle = new ArrayList<JAXBElement<? extends oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>>();
        }
        return this.vehicle;
    }
