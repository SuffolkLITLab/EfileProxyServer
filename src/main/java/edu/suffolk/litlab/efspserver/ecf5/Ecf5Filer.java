...
public class Ecf5Filer extends EfmCheckableFilingInterface {
  ...
  public Ecf5Filer(String jurisdiction, String env) {
    ...
    Optional<CourtPolicyMDEService> maybePolicy = SoapClientChooser.getCourtPolicyFactory(jurisdiction, env);
    if (maybePolicy.isEmpty()) {
      throw new RuntimeException("Cannot find " + jurisdiction + " in " + env + " for court policy service factory");
    }
  ...
  @Override
  public Response getFilingList(String courtId, String submitterId, LocalDate startDate, LocalDate beforeDate,
      String apiToken) {
    // TODO Auto-generated method stub
  ...
  public Response getPolicy(String courtId, String apiToken) {
    try {
      ...
      return Response.status(500).entity("Couldn't access database: " + StdLib.strFromException(ex)).build();
    }
