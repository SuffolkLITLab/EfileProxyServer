...
public class SoapClientChooser {
  ...
  static final Map<String, String> tylerCourtSchedulingMDEWsdls =
      Map.of("illinois-stage", "wsdl/stage/illinois-v5-TylerCourtSchedulingMDE.wsdl");
  ...
  public static Optional<TylerCourtSchedulingMDEService> getTylerCourtSchedulingFactory(
      String wsdlDomain) {
    Optional<URL> url = urlFromString(wsdlDomain, tylerCourtSchedulingMDEWsdls);
    return url.map(u -> new TylerCourtSchedulingMDEService(u));
  }

  public static Optional<TylerCourtSchedulingMDEService> getTylerCourtSchedulingFactory(
      String jurisdiction, String env) {
    return getTylerCourtSchedulingFactory(jurisdiction + "-" + env);
  }
