...
public class SoapClientChooser {
  ...
  private final static Logger log =
      LoggerFactory.getLogger(SoapClientChooser.class);

  static final Map<String, String> efmUserWsdls = Map.of(
  ...
  static final Map<String, String> serviceMDEWsdls = Map.of(
  ...
  static final Map<String, String> filingReviewMDEWsdls = Map.of(
  ...
  static final Map<String, String> courtRecordMDEWsdls = Map.of(
  ...
  static final Map<String, String> courtSchedulingMDEWsdls = Map.of(
  ...
  public static String getCodeEndpointRootUrl(String jurisdiction, String env) {
    if ((jurisdiction.equalsIgnoreCase("massachusetts") || jurisdiction.equalsIgnoreCase("illinois")) && env.equalsIgnoreCase("prod")) {
  ...
  public static Optional<CourtSchedulingMDE_Service> getCourtSchedulingFactory(String jurisdiction, String env) {
