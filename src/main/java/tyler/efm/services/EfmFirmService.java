 ...
 * 2021-03-31T18:23:52.248-04:00
 * Generated source version: 3.5.0-SNAPSHOT
 *
 */
@WebServiceClient(name = "EfmFirmService",
                  wsdlLocation = "file:/home/brycew/eclipse-workspace/ArtifactId/EFMFirmService.svc.wsdl",
...
public class EfmFirmService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/brycew/eclipse-workspace/ArtifactId/EFMFirmService.svc.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmFirmService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/brycew/eclipse-workspace/ArtifactId/EFMFirmService.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
