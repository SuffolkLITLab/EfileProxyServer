 ...
 * 2021-04-01T12:59:20.312-04:00
 * Generated source version: 3.5.0-SNAPSHOT
 *
 */
@WebServiceClient(name = "EfmUserService",
                  wsdlLocation = "file:/home/brycew/eclipse-workspace/ArtifactId/EFMUserService.svc.wsdl",
...
public class EfmUserService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/brycew/eclipse-workspace/ArtifactId/EFMUserService.svc.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmUserService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/brycew/eclipse-workspace/ArtifactId/EFMUserService.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
