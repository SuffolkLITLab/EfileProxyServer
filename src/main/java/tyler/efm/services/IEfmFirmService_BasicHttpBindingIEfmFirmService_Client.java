 ...
 * 2024-06-17T22:54:13.341-04:00
 * Generated source version: 4.0.4
 *
 */
public final class IEfmFirmService_BasicHttpBindingIEfmFirmService_Client {

    private static final QName SERVICE_NAME = new QName("urn:tyler:efm:services", "EfmFirmService");

    private IEfmFirmService_BasicHttpBindingIEfmFirmService_Client() {
    }
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        {
        System.out.println("Invoking replaceServiceContact...");
        tyler.efm.services.schema.replaceservicecontactrequesttype.ReplaceServiceContactRequestType _replaceServiceContact_replaceServiceContactRequest = null;
        tyler.efm.services.schema.baseresponse.BaseResponseType _replaceServiceContact__return = port.replaceServiceContact(_replaceServiceContact_replaceServiceContactRequest);
        System.out.println("replaceServiceContact.result=" + _replaceServiceContact__return);
