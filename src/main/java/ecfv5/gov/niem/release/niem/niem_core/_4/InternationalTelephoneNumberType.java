    ...
    extends ObjectType
{
    ...
    protected ecfv5.gov.niem.release.niem.proxy.xsd._4.String telephoneCountryCodeID;
    @XmlElement(name = "TelephoneNumberID", required = true)
    protected ecfv5.gov.niem.release.niem.proxy.xsd._4.String telephoneNumberID;
     ...
     *     
     */
    public ecfv5.gov.niem.release.niem.proxy.xsd._4.String getTelephoneCountryCodeID() {
     ...
     *     
     */
    public void setTelephoneCountryCodeID(ecfv5.gov.niem.release.niem.proxy.xsd._4.String value) {
     ...
     *     
     */
    public ecfv5.gov.niem.release.niem.proxy.xsd._4.String getTelephoneNumberID() {
     ...
     *     
     */
    public void setTelephoneNumberID(ecfv5.gov.niem.release.niem.proxy.xsd._4.String value) {
