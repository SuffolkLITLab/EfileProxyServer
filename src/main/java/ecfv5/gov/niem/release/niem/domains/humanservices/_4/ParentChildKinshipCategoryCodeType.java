...
/**
 * A data type for describing the nature of the relationship from a parent to a child
 * 
 * <p>Java class for ParentChildKinshipCategoryCodeType complex type.
 * 
...
@XmlType(name = "ParentChildKinshipCategoryCodeType", propOrder = {
    "value"
})
public class ParentChildKinshipCategoryCodeType {

    @XmlValue
    protected ParentChildKinshipCategoryCodeSimpleType value;
     ...
     * @return
     *     possible object is
     *     {@link ParentChildKinshipCategoryCodeSimpleType }
     *     
     */
    public ParentChildKinshipCategoryCodeSimpleType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(ParentChildKinshipCategoryCodeSimpleType value) {
        this.value = value;
    }
