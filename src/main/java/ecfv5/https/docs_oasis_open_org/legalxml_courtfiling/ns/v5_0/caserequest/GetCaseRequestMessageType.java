    ...
    extends RequestMessageType
{
    ...
    protected List<ecfv5.gov.niem.release.niem.proxy.xsd._4.String> caseTrackingID;
     ...
     * 
     */
    public List<ecfv5.gov.niem.release.niem.proxy.xsd._4.String> getCaseTrackingID() {
        if (caseTrackingID == null) {
            caseTrackingID = new ArrayList<ecfv5.gov.niem.release.niem.proxy.xsd._4.String>();
        }
