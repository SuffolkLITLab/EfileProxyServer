    ...
    extends AugmentationType
{
    ...
    protected List<ecfv5.gov.niem.release.niem.proxy.xsd._4.String> caseDocketID;
     ...
     * 
     */
    public List<ecfv5.gov.niem.release.niem.proxy.xsd._4.String> getCaseDocketID() {
        if (caseDocketID == null) {
            caseDocketID = new ArrayList<ecfv5.gov.niem.release.niem.proxy.xsd._4.String>();
        }
