...
import ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.CertificateTypeCodeType;
 ...
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}CertificateTypeCode"/&gt;
...
public class CertificateType {
    ...
    protected IDType id;
    @XmlElement(name = "CertificateTypeCode", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2", required = true)
