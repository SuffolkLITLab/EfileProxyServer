...
import ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.DutyCodeType;
 ...
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}Duty" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}DutyCode" minOccurs="0"/&gt;
...
public class DutyType {
    ...
    @XmlElement(name = "Duty", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.DutyType duty;
    @XmlElement(name = "DutyCode", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
     ...
     * @return
     *     possible object is
     *     {@link ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.DutyType }
     *     
     */
    public ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.DutyType getDuty() {
        return duty;
    }
     ...
     *     
     */
    public void setDuty(ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.DutyType value) {
        this.duty = value;
    }
