...
import ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.LicensePlateIDType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}LicensePlateID"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class RoadTransportType {
    ...
    @XmlElement(name = "LicensePlateID", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2", required = true)
