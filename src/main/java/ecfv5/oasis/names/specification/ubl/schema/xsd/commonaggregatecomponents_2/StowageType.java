...
import ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.LocationIDType;
import ecfv5.oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.LocationType;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}LocationID" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}Location" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class StowageType {
    ...
    @XmlElement(name = "LocationID", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected LocationIDType locationID;
    @XmlElement(name = "Location", namespace = "urn:ecfv5.oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
