...
public class CourtSchedulingClient {
  private ecf5.v2024_6.https.docs_oasis_open_org.legalxml_courtfiling.ns.v5_0wsdl.courtschedulingmde
          .CourtSchedulingMDE
      v2024Port;
  private TylerVersion version;

  public CourtSchedulingClient(
      CourtSchedulingMDEService factory, TylerVersion version, Consumer<BindingProvider> setup) {
