...
public class XmlArbitraries<T extends Object> extends ArbitraryDecorator<T>
  ...
  public XmlArbitraries(Class<T> targetType) {
  ...
  private XmlArbitraries<T> cloneWithoutDefaultsSet() {
    XmlArbitraries<T> clone = typedClone();
  ...
  public TypeArbitrary<T> useConstructors(Predicate<? super Constructor<?>> filter) {
    XmlArbitraries<T> clone = cloneWithoutDefaultsSet();
  ...
  class TypeTraverser implements TraverseArbitrary.Traverser {
    ...
    private void appendConstructors(
        Set<Executable> creators, TypeUsage target, Predicate<? super Constructor<?>> filter) {
    ...
    private void appendFactoryMethods(
        Set<Executable> creators, TypeUsage target, Predicate<? super Method> filter) {
