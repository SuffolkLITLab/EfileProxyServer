...
import edu.suffolk.litlab.efsp.server.auth.JeffNetLogin;
import edu.suffolk.litlab.efsp.server.jeffnet.ContactInfoJeffNetJacksonSerializer;
import edu.suffolk.litlab.efsp.server.jeffnet.FilingInformationJeffNetSerializer;
import edu.suffolk.litlab.efsp.server.jeffnet.FilingJeffNetJacksonSerializer;
import edu.suffolk.litlab.efsp.server.jeffnet.NameJeffNetJacksonSerializer;
import edu.suffolk.litlab.efsp.server.jeffnet.PersonJeffNetJacksonSerializer;
