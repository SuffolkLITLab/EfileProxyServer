...
public class TylerCodesService extends CodesService {
  private static Logger log = LoggerFactory.getLogger(TylerCodesService.class);
  ...
  public TylerCodesService(Jurisdiction jurisdiction, Supplier<CodeDatabase> cdSupplier) {
