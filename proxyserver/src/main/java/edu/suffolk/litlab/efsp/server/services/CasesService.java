...
public class CasesService {
  ...
  public Response getCaseList(
    ...
    if (docketId != null) {
      return delegate.queryCases(courtId, docketId, creds, ReturnType.LEGACY_XML);
    }

    if (firstName != null && lastName != null) {
      Name name = new Name(firstName, middleName, lastName);
      return delegate.queryCases(courtId, name, false, creds, ReturnType.LEGACY_XML);
    }
    if (businessName != null) {
      return delegate.queryCases(
          courtId, new Name(businessName), false, creds, ReturnType.LEGACY_XML);
    }
  ...
  public Response getCase(
    ...
    EfspSecurityContext efspSecurity = (EfspSecurityContext) security;
    var creds = efspSecurity.getUserCreds();
    return delegate.getCase(courtId, caseId, creds, ReturnType.LEGACY_XML);
  }
