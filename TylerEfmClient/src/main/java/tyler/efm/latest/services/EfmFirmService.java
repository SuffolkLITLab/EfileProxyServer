 ...
 * 2026-01-27T09:44:22.733-05:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "EfmFirmService",
                  wsdlLocation = "file:../TylerEfmClient/src/main/resources/wsdl/v2025_4//stage/illinois-EFMFirmServiceSingle.svc.wsdl",
...
public class EfmFirmService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:../TylerEfmClient/src/main/resources/wsdl/v2025_4//stage/illinois-EFMFirmServiceSingle.svc.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmFirmService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:../TylerEfmClient/src/main/resources/wsdl/v2025_4//stage/illinois-EFMFirmServiceSingle.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
