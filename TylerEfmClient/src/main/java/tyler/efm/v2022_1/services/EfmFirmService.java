 ...
 * 2025-06-17T14:54:20.601-04:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "EfmFirmService",
                  wsdlLocation = "file:resources/wsdl/v2022_1/prod/massachusetts-EFMFirmServiceSingle.svc.wsdl",
...
public class EfmFirmService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:resources/wsdl/v2022_1/prod/massachusetts-EFMFirmServiceSingle.svc.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmFirmService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:resources/wsdl/v2022_1/prod/massachusetts-EFMFirmServiceSingle.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
