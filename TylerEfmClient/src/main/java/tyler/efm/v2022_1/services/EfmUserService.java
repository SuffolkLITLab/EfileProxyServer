 ...
 * 2025-06-13T15:18:31.804-04:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "EfmUserService",
                  wsdlLocation = "file:resources/wsdl/v2022_1/illinois-EFMUserServiceSingle.svc.wsdl",
...
public class EfmUserService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:resources/wsdl/v2022_1/illinois-EFMUserServiceSingle.svc.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmUserService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:resources/wsdl/v2022_1/illinois-EFMUserServiceSingle.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
