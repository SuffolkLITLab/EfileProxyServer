 ...
 * 2025-06-17T14:54:17.865-04:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "EfmUserService",
                  wsdlLocation = "file:resources/wsdl/v2022_1/prod/massachusetts-EFMUserServiceSingle.svc.wsdl",
...
public class EfmUserService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:resources/wsdl/v2022_1/prod/massachusetts-EFMUserServiceSingle.svc.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EfmUserService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:resources/wsdl/v2022_1/prod/massachusetts-EFMUserServiceSingle.svc.wsdl");
        }
        WSDL_LOCATION = url;
    }
