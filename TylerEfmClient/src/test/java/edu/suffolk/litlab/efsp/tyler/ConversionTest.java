...
public class ConversionTest {
  ...
  public void testAuth() {
    var oldAuth =
        new tyler.efm.v2022_1.services.schema.authenticaterequest.AuthenticateRequestType();
    oldAuth.setEmail("idk@idk.com");
    var newAuth =
        Conversion.convert(
            tyler.efm.latest.services.schema.authenticaterequest.AuthenticateRequestType.class,
            oldAuth);
  ...
  public void allRequests()
    ...
    v2022_classes.add(
        tyler.efm.v2022_1.services.schema.registrationresponse.RegistrationResponseType.class);
    ...
    v2025_classes.add(
        tyler.efm.latest.services.schema.updatenotificationpreferencesrequest
            .UpdateNotificationPreferencesRequestType.class);
    v2025_classes.add(
        tyler.efm.latest.services.schema.registrationrequest.RegistrationRequestType.class);
    v2025_classes.add(
        tyler.efm.latest.services.schema.registrationresponse.RegistrationResponseType.class);
