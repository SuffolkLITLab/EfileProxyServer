 ...
 * 2026-01-27T16:46:39.632-05:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "FilingReviewMDEService",
                  wsdlLocation = "file:stage/illinois-ECF-4.0-FilingReviewMDEService.wsdl",
...
public class FilingReviewMDEService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:stage/illinois-ECF-4.0-FilingReviewMDEService.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FilingReviewMDEService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:stage/illinois-ECF-4.0-FilingReviewMDEService.wsdl");
        }
        WSDL_LOCATION = url;
    }
