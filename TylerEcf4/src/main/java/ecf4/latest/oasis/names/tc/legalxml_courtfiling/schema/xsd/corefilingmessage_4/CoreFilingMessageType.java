...
package ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.corefilingmessage_4;
    ...
    extends ElectronicFilingMessageType
{
    ...
    protected List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> filingLeadDocument;
    ...
    protected List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> filingConnectedDocument;
     ...
     * {@link JAXBElement }{@code <}{@link ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType }{@code >}
     * {@link JAXBElement }{@code <}{@link ecf4.latest.tyler.ecf.extensions.common.DocumentType }{@code >}
     * 
     * 
     */
    public List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> getFilingLeadDocument() {
        if (filingLeadDocument == null) {
            filingLeadDocument = new ArrayList<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>>();
        }
     ...
     * 
     */
    public List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>> getFilingConnectedDocument() {
        if (filingConnectedDocument == null) {
            filingConnectedDocument = new ArrayList<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType>>();
        }
