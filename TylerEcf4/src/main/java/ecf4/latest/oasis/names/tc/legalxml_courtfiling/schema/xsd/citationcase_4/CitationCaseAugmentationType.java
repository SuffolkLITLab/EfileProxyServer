...
import ecf4.latest.gov.niem.niem.domains.jxdm._4.CitationType;
import ecf4.latest.gov.niem.niem.domains.jxdm._4.CourtAppearanceType;
import ecf4.latest.gov.niem.niem.domains.jxdm._4.ViolatedStatuteAssociationType;
...
import ecf4.latest.tyler.ecf.extensions.common.CitationAugmentationType;
    ...
    extends ComplexObjectType
{
    ...
    protected List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>> vehicle;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link JAXBElement }{@code <}{@link ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType }{@code >}
     * {@link JAXBElement }{@code <}{@link ecf4.latest.tyler.ecf.extensions.common.VehicleType }{@code >}
     * 
     * 
     */
    public List<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>> getVehicle() {
        if (vehicle == null) {
            vehicle = new ArrayList<JAXBElement<? extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.citationcase_4.VehicleType>>();
        }
        return this.vehicle;
    }
