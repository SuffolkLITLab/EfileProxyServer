...
public class CourtEventDocumentType
    extends ecf4.latest.oasis.names.tc.legalxml_courtfiling.schema.xsd.commontypes_4.DocumentType
{

    @XmlElement(name = "ConnectedDocument")
    protected List<ecf4.latest.gov.niem.niem.niem_core._2.DocumentType> connectedDocument;
     ...
     * {@link ecf4.latest.gov.niem.niem.niem_core._2.DocumentType }
     * 
     * 
     */
    public List<ecf4.latest.gov.niem.niem.niem_core._2.DocumentType> getConnectedDocument() {
        if (connectedDocument == null) {
            connectedDocument = new ArrayList<ecf4.latest.gov.niem.niem.niem_core._2.DocumentType>();
        }
