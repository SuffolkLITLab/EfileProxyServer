...
import ecf4.latest.oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2.PercentType;
import ecf4.latest.oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2.RateType;
import ecf4.latest.oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2.ValueType;
...
@XmlSeeAlso({
    ecf4.latest.oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2.NumericType.class,
    ValueType.class,
    PercentType.class,
    RateType.class
})
