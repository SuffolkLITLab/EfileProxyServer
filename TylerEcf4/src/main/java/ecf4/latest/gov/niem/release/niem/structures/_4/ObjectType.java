...
import ecf4.latest.gov.niem.release.niem.domains.biometrics._4.BiometricClassificationType;
import ecf4.latest.gov.niem.release.niem.domains.biometrics._4.BiometricDataType;
import ecf4.latest.gov.niem.release.niem.domains.biometrics._4.DNASTRProfileType;
import ecf4.latest.gov.niem.release.niem.domains.biometrics._4.DNASampleType;
...
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.DriverLicenseBaseType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.DrivingRestrictionType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.EnforcementOfficialType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.ItemRegistrationType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.JudicialOfficialBarMembershipType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.JudicialOfficialType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.OrganizationAlternateNameType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.RegisteredOffenderType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.SeverityLevelType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.StatuteType;
import ecf4.latest.gov.niem.release.niem.domains.jxdm._6.SubjectType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ActivityType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.AddressType;
...
import ecf4.latest.gov.niem.release.niem.niem_core._4.CapabilityType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ContactInformationType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.CountryType;
...
import ecf4.latest.gov.niem.release.niem.niem_core._4.DispositionType;
...
import ecf4.latest.gov.niem.release.niem.niem_core._4.FullTelephoneNumberType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.IdentificationType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.InsuranceType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.InternationalTelephoneNumberType;
...
import ecf4.latest.gov.niem.release.niem.niem_core._4.MeasureType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.NANPTelephoneNumberType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ObligationExemptionType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ObligationRecurrenceType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ObligationType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.OrganizationType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.PersonLanguageType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.PersonNameType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.PersonType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.PhysicalFeatureType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ScheduleDayType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.ScheduleType;
import ecf4.latest.gov.niem.release.niem.niem_core._4.StateType;
