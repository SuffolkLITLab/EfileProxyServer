    ...
    extends ObjectType
{
    ...
    protected ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String telephoneAreaCodeID;
    @XmlElement(name = "TelephoneExchangeID", required = true)
    protected ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String telephoneExchangeID;
    @XmlElement(name = "TelephoneLineID", required = true)
    protected ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String telephoneLineID;
     ...
     *     
     */
    public ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String getTelephoneAreaCodeID() {
     ...
     *     
     */
    public void setTelephoneAreaCodeID(ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String value) {
     ...
     *     
     */
    public ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String getTelephoneExchangeID() {
     ...
     *     
     */
    public void setTelephoneExchangeID(ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String value) {
     ...
     *     
     */
    public ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String getTelephoneLineID() {
     ...
     *     
     */
    public void setTelephoneLineID(ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String value) {
