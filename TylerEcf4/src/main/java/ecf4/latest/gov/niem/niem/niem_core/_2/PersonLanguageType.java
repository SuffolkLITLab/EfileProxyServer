 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://niem.gov/niem/niem-core/2.0}Language" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends ComplexObjectType
{
    ...
    @XmlElementRef(name = "Language", namespace = "http://niem.gov/niem/niem-core/2.0", type = JAXBElement.class)
    protected List<JAXBElement<?>> language;
     ...
     * 
     */
    public List<JAXBElement<?>> getLanguage() {
        if (language == null) {
            language = new ArrayList<JAXBElement<?>>();
        }
