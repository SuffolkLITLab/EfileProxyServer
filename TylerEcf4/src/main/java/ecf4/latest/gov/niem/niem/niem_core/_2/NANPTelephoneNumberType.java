    ...
    extends ComplexObjectType
{
    ...
    protected ecf4.latest.gov.niem.niem.proxy.xsd._2.String telephoneAreaCodeID;
    @XmlElement(name = "TelephoneExchangeID", required = true, nillable = true)
    protected ecf4.latest.gov.niem.niem.proxy.xsd._2.String telephoneExchangeID;
    @XmlElement(name = "TelephoneLineID", required = true, nillable = true)
    protected ecf4.latest.gov.niem.niem.proxy.xsd._2.String telephoneLineID;
     ...
     *     
     */
    public ecf4.latest.gov.niem.niem.proxy.xsd._2.String getTelephoneAreaCodeID() {
     ...
     *     
     */
    public void setTelephoneAreaCodeID(ecf4.latest.gov.niem.niem.proxy.xsd._2.String value) {
     ...
     *     
     */
    public ecf4.latest.gov.niem.niem.proxy.xsd._2.String getTelephoneExchangeID() {
     ...
     *     
     */
    public void setTelephoneExchangeID(ecf4.latest.gov.niem.niem.proxy.xsd._2.String value) {
     ...
     *     
     */
    public ecf4.latest.gov.niem.niem.proxy.xsd._2.String getTelephoneLineID() {
     ...
     *     
     */
    public void setTelephoneLineID(ecf4.latest.gov.niem.niem.proxy.xsd._2.String value) {
