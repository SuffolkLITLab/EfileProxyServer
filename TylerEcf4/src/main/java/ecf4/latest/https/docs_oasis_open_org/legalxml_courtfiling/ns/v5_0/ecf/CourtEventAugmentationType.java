    ...
    extends AugmentationType
{
    ...
    protected List<ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String> caseDocketID;
     ...
     * 
     */
    public List<ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String> getCaseDocketID() {
        if (caseDocketID == null) {
            caseDocketID = new ArrayList<ecf4.latest.gov.niem.release.niem.proxy.xsd._4.String>();
        }
