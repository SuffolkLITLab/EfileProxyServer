 ...
 * 2026-01-27T16:52:28.123-05:00
 * Generated source version: 4.0.8
 *
 */
@WebServiceClient(name = "CourtSchedulingMDE",
                  wsdlLocation = "file:stage/illinois-v5-CourtSchedulingMDE.wsdl",
...
public class CourtSchedulingMDE_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = URI.create("file:stage/illinois-v5-CourtSchedulingMDE.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CourtSchedulingMDE_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:stage/illinois-v5-CourtSchedulingMDE.wsdl");
        }
        WSDL_LOCATION = url;
    }
