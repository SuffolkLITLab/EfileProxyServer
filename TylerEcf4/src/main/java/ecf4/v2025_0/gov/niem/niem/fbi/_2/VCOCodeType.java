...
/**
 * <p>Java class for VCOCodeType complex type.
 * 
 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://niem.gov/niem/fbi/2.0&gt;VCOCodeSimpleType"&gt;
...
@XmlType(name = "VCOCodeType", propOrder = {
    "value"
})
public class VCOCodeType {

    @XmlValue
    protected VCOCodeSimpleType value;
     ...
     * @return
     *     possible object is
     *     {@link VCOCodeSimpleType }
     *     
     */
    public VCOCodeSimpleType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(VCOCodeSimpleType value) {
        this.value = value;
    }
