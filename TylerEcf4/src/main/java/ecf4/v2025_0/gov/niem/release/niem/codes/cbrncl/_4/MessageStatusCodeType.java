...
/**
 * A data type that defines the status of a message.
 * 
 * <p>Java class for MessageStatusCodeType complex type.
 * 
...
@XmlType(name = "MessageStatusCodeType", propOrder = {
    "value"
})
public class MessageStatusCodeType {

    @XmlValue
    protected MessageStatusCodeSimpleType value;
     ...
     * @return
     *     possible object is
     *     {@link MessageStatusCodeSimpleType }
     *     
     */
    public MessageStatusCodeSimpleType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(MessageStatusCodeSimpleType value) {
        this.value = value;
    }
