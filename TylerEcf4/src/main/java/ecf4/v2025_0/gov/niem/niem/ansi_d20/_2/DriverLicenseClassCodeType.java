...
package ecf4.v2025_0.gov.niem.niem.ansi_d20._2;
...
/**
 * <p>Java class for DriverLicenseClassCodeType complex type.
 * 
 ...
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;http://niem.gov/niem/ansi_d20/2.0&gt;DriverLicenseClassCodeSimpleType"&gt;
...
@XmlType(name = "DriverLicenseClassCodeType", propOrder = {
    "value"
})
public class DriverLicenseClassCodeType {

    @XmlValue
    protected DriverLicenseClassCodeSimpleType value;
     ...
     * @return
     *     possible object is
     *     {@link DriverLicenseClassCodeSimpleType }
     *     
     */
    public DriverLicenseClassCodeSimpleType getValue() {
        return value;
    }
     ...
     *     
     */
    public void setValue(DriverLicenseClassCodeSimpleType value) {
        this.value = value;
    }
