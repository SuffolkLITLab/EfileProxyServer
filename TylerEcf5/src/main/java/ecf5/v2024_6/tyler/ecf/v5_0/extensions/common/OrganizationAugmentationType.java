 ...
 *         &lt;element ref="{urn:tyler:ecf:v5.0:extensions:common}AddMeAsServiceContactIndicator" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "OrganizationAugmentationType", propOrder = {
    ...
    "agency",
    "alias",
    "addMeAsServiceContactIndicator"
})
    ...
    extends AugmentationType
{
    ...
    @XmlElement(name = "AddMeAsServiceContactIndicator")
    protected Boolean addMeAsServiceContactIndicator;
    ...
    /**
     * Gets the value of the addMeAsServiceContactIndicator property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean getAddMeAsServiceContactIndicator() {
        return addMeAsServiceContactIndicator;
    }

    /**
     * Sets the value of the addMeAsServiceContactIndicator property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setAddMeAsServiceContactIndicator(Boolean value) {
        this.addMeAsServiceContactIndicator = value;
    }
