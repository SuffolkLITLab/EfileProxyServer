 ...
 *         &lt;element ref="{urn:tyler:ecf:v5.0:extensions:common}BlackoutStatus" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
    ...
    extends AugmentationType
{
    ...
    @XmlElement(name = "DocumentFiledDate", namespace = "http://release.niem.gov/niem/niem-core/4.0/")
    protected DateType documentFiledDate;
    @XmlElement(name = "BatchIdentification")
    protected IdentificationType batchIdentification;
    @XmlElement(name = "BlackoutStatus")
    protected List<BlackoutStatusType> blackoutStatus;
    ...
    /**
     * Gets the value of the blackoutStatus property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the blackoutStatus property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBlackoutStatus().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BlackoutStatusType }
     * 
     * 
     */
    public List<BlackoutStatusType> getBlackoutStatus() {
        if (blackoutStatus == null) {
            blackoutStatus = new ArrayList<BlackoutStatusType>();
        }
