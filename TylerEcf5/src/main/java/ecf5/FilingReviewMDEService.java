...
public class FilingReviewMDEService extends Service {
    ...
    public static final QName SERVICE = new QName("https://docs.oasis-open.org/legalxml-courtfiling/ns/v5.0WSDL/FilingReviewMDE", "FilingReviewMDEService");
    public static final QName FilingReviewMDE = new QName("https://docs.oasis-open.org/legalxml-courtfiling/ns/v5.0WSDL/FilingReviewMDE", "FilingReviewMDE");
    static {
        URL url = null;
        try {
            ...
            java.util.logging.Logger.getLogger(FilingReviewMDEService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:../stage/illinois-ECF5-FilingReviewMDEService.wsdl");
        }
        WSDL_LOCATION = url;
    }
