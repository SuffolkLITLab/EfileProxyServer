...
public class CourtPolicyClient {
  private ecf5.v2024_6.https.docs_oasis_open_org.legalxml_courtfiling.ns.v5_0wsdl.courtpolicymde
          .CourtPolicyMDE
      v2024Port;
  private TylerVersion version;

  public CourtPolicyClient(
      CourtPolicyMDEService factory, TylerVersion version, Consumer<BindingProvider> setup) {
