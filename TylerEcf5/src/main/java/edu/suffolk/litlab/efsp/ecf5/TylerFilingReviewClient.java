...
public class TylerFilingReviewClient {
  private ecf5.v2024_6.tyler.ecf.v5_0.extensions.tylerfilingreviewmde.TylerFilingReviewMDE
      v2024Port;
  private TylerVersion version;

  public TylerFilingReviewClient(
      TylerFilingReviewMDEService factory, TylerVersion version, Consumer<BindingProvider> setup) {
  ...
  public ecf5.v2024_6.tyler.ecf.v5_0.extensions.wrappers.GetFilingServiceResponseType
      getFilingService(
          ecf5.v2024_6.tyler.ecf.v5_0.extensions.wrappers.GetFilingServiceRequestType body) {
    return v2024Port.getFilingService(body);
  }

  public ecf5.v2024_6.tyler.ecf.v5_0.extensions.wrappers.GetServiceTypesResponseType
      getServiceTypes(
