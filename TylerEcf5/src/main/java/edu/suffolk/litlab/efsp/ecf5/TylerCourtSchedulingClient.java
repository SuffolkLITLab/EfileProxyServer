...
public class TylerCourtSchedulingClient {
    private ecf5.v2024_6.tyler.ecf.v5_0.extensions.tylercourtschedulingmde.TylerCourtSchedulingMDE v2024Port;
    private TylerVersion version;

    public TylerCourtSchedulingClient(TylerCourtSchedulingMDEService factory, TylerVersion version, Consumer<BindingProvider> setup) {
